...
namespace Spg.DomainLinQ.App.Infrastructure
{
    ...
    public class School2000Context : DbContext
    {
        ...
        { }
        public School2000Context(DbContextOptions options) 
            : base(options)
        { }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Student>().Property(x => x.Id).IsRequired();
            modelBuilder.Entity<Teacher>().HasKey(x => x.Id);
            modelBuilder.Entity<Teacher>().Property(x => x.Id).IsRequired();
            modelBuilder.Entity<SchoolClass>().HasKey(x => x.Id);
            modelBuilder.Entity<SchoolClass>().Property(x => x.Id).IsRequired();
            modelBuilder.Entity<Exam>().HasKey(x => x.Id);
            modelBuilder.Entity<Exam>().Property(x => x.Id).IsRequired();
            modelBuilder.Entity<Subject>().HasKey(x => x.Id);
            modelBuilder.Entity<Subject>().Property(x => x.Id).IsRequired();
           ...
           modelBuilder.Entity<Teacher>().OwnsOne(s => s.Address);
        }
